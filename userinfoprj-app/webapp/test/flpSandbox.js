		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UserinfoPrj App",
									"targetURL": "#mycompanyuserinfoprjapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mycompanyuserinfoprjapp-display": {
								"semanticObject": "mycompanyuserinfoprjapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=my.company.userinfoprjapp",
									"url": sap.ui.require.toUrl("my/company/userinfoprjapp")
								}
							}
						}
					}
